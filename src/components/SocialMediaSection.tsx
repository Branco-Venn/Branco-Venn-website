...
const socials = [
  {
    ...
    bgColor: "bg-gradient-to-br from-purple-600 via-pink-500 via-orange-500 to-yellow-500",
    bgImage: undefined,
    icon: (
      <svg viewBox="0 0 24 24" className="h-12 w-12 md:h-14 md:w-14" fill="white">
  ...
  },
  {
    ...
    bgImage: undefined,
    icon: (
      <svg viewBox="0 0 24 24" className="h-12 w-16 md:h-14 md:w-20" fill="white">
  ...
  },
  {
    ...
    bgImage: undefined,
    icon: (
      <svg viewBox="0 0 24 24" className="h-8 w-8 md:h-10 md:w-10" fill="white">
