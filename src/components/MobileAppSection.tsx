    ...
    <section id="mobile" className="relative py-32 md:py-40">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        >
          ...
          <motion.a
            href="#"
            className="group relative overflow-hidden flex items-center gap-4 rounded-2xl border border-foreground/10 bg-foreground/5 backdrop-blur-md px-8 py-5 transition-all duration-300 hover:border-foreground/20 hover:bg-foreground/10 hover:-translate-y-1 hover:shadow-[0_15px_30px_-10px_rgba(0,0,0,0.3)]"
          >
